...
<head>
	...
	<meta name="keywords"
		content="drpaulovet, dr.paulovet., dr paulo vet, dr. paulo vet.,  dr.paulovet, clinica veterinaria, pet shop, petshop, clinica veterinaria e pet shop, clinica veterinaria e petshop, disk entrega, disk racao" />
	<meta name="description"
		content="Dr. Paulo Vet. é uma Clínica Veterinária e Pet Shop localizada em Manaus. Vacinas, exames, cirurgias, medicamentos, rações, disk entrega e muito mais. Entre e confira!" />
...
<body data-spy="scroll" data-offset="120">
	...
	<div class="fb-customerchat" attribution=setup_tool page_id="367639233887637"
		logged_in_greeting="Olá! Como podemos ajudar você?" logged_out_greeting="Olá! Como podemos ajudar você?">
	</div>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="ml-0 ml-md-4 mb-2 mb-md-0 mt-3 mt-md-0 btn btn-outline-info"
							href="https://wa.me/559292156295?text=Ol%C3%A1%2C%20Dr.%20Paulo%20Vet.%20%F0%9F%98%8A"
							target="_blank">
							MARCAR CONSULTA
						</a>
					</li>
			...
			<div class="container p-5">
				<div class="row">
					...
					<article class="col-12 col-md-4 mb-5 mb-md-0">
						...
						<div class="row text-center">
							<div class="col-12">
								<a class="btn btn-outline-info" href="https://linktr.ee/dr.paulovet" target="_blank">
									Acessar </a>
							</div>
						</div>
					</article>
					...
					<article class="col-12 col-md-4">
						...
						<div class="row text-center">
							<div class="col-12">
								<a class="btn btn-outline-info" href="https://g.page/dr.paulovet" target="_blank"> Como
									Chegar </a>
							</div>
						</div>
					</article>
			...
			<div class="container px-5 pb-5">
				<div class="row">
					<article class="col-12 col-md-4 block-one p-5">
						...
						<p class="mb-0"> A Clínica Veterinária e Pet Shop Dr. Paulo Vet. foi criada para oferecer à
							população de Manaus e região um novo conceito em atendimento veterinário. Aliando nossa
							qualidade técnica à um carinho especial por nossos pacientes. </p>
					</article>

					<article class="col-12 col-md-4 block-two p-5">
						<h3 class="mb-4"> Dr. Paulo Vet. </h3>
						<p class="mb-0"> Sou suspeito para falar, mas sou apaixonado pela minha profissão. Cuidar
							diariamente de pets e vê-los alcançando o seu melhor estado de saúde não tem preço. </p>
					</article>
		...
		<section id="resumo">
			<div class="container p-5">
				<div class="row mb-5">
					...
					<p class="m-0 col-12 text-secondary section-description"> Nossa clínica veterinária dispõe de
						diversas especialidades, enquanto nosso pet shop oferece produtos desde rações à medicamentos.
					</p>
				</div>
		...
		<section id="depoimentos">
			<div class="container p-5">
				<article class="row mb-5">
					...
					<p class="m-0 col-12 text-secondary text-center section-description"> Veja a opinião de quem sabe o
						que é ser cliente da melhor Clínica Veterinária e Pet Shop de Manaus </p>
				</article>

				<div class="row">
					<article class="col-12 col-md-4 px-0 px-md-5 mb-5 mb-md-0">
						<div class="block py-4  text-center shadow">
							<img class="rounded-circle shadow" src="_img/main/depoimentos/1.jpeg"
								alt="Cliente Dr. Paulo Vet.">
							<p class="name mt-2 mb-0 px-5"> Ivone Azevedo </p>
							<p class="commentary mt-2 mb-0 px-4 text-secondary"> Levo a Nina ao Dr. Paulo Vet. desde
								quando ela era apenas uma filhote, pois sei que ela sempre será tratada com muito
								carinho. </p>
						</div>
					</article>
					...
					<article class="col-12 col-md-4 px-0 px-md-5 mb-5 mb-md-0">
						<div class="block py-4  text-center shadow">
							<img class="rounded-circle shadow" src="_img/main/depoimentos/2.jpeg"
								alt="Cliente Dr. Paulo Vet.">
							<p class="name mt-2 mb-0 px-5"> Adriana Souza </p>
							<p class="commentary mt-2 mb-0 px-4 text-secondary"> A Bia precisou passar por cirurgia para
								a retirada de nódulos na mama e castração, os procedimentos foram um sucesso. </p>
						</div>
					</article>
		...
		<section id="especialidades">
			<div class="container p-5">
				<div class="row mb-1">
					...
					<p class="m-0 col-12 text-secondary section-description d-none d-md-block"> Nossas instalações
						atendem diversas especialidades veterinárias, trazendo os mais avançados recursos de saúde.
						Marque uma consulta via WhatsApp. </p>
					<p class="m-0 col-12 text-secondary section-description d-block d-md-none"> Nossas instalações
						atendem diversas especialidades veterinárias. Marque uma consulta via WhatsApp. </p>
				...
				<h3 class="col-12 text-center pt-5 pb-3"> Parceria </h3>

				<div class="text-center col-12 pb-3">
					<img style="width: 125px; height: 125px;" class="rounded"
						src="./_img/main/especialidades/dogtor-x.jpeg" alt="">
				</div>

				<div class="row text-center">
					<div class="col-12 col-md-4 p-4">
						<div class="px-4 block shadow">
							<img class="mt-5" src="_img/main/especialidades/9.png" alt="Consultas">
							<p class="mt-2 mb-0"> Raio X com Laudo </p>
						</div>
					</div>
				</div>
				...
				<div class="text-center col-12 pb-3">
					<img style="width: 125px; height: 125px;" class="rounded border"
						src="./_img/main/especialidades/vet-lab.jpeg" alt="">
				</div>

				<div class="row text-center">
					<div class="col-12 col-md-4 p-4">
						<div class="px-4 block shadow">
							<img class="mt-5" src="_img/main/especialidades/10.png" alt="Consultas">
							<p class="mt-2 mb-0"> Hematologia </p>
						</div>
					</div>

					<div class="col-12 col-md-4 p-4">
						<div class="px-4 block shadow">
							<img class="mt-5" src="_img/main/especialidades/11.png" alt="Consultas">
							<p class="mt-2 mb-0"> Parasitológico </p>
						</div>
					</div>

					<div class="col-12 col-md-4 p-4">
						<div class="px-4 block shadow">
							<img class="mt-5" src="_img/main/especialidades/12.png" alt="Consultas">
							<p class="mt-2 mb-0"> Urinálise </p>
						</div>
					</div>

					<div class="col-12 col-md-4 p-4">
						<div class="px-4 block shadow">
							<img class="mt-5" src="_img/main/especialidades/13.png" alt="Consultas">
							<p class="mt-2 mb-0"> Testes Rápidos </p>
						</div>
					</div>

					<div class="col-12 col-md-4 p-4">
						<div class="px-4 block shadow">
							<img class="mt-5" src="_img/main/especialidades/14.png" alt="Consultas">
							<p class="mt-2 mb-0"> Bioquímicos </p>
						</div>
					</div>

					<div class="col-12 col-md-4 p-4">
						<div class="px-4 block shadow">
							<img class="mt-5" src="_img/main/especialidades/15.png" alt="Consultas">
							<p class="mt-2 mb-0"> Citologias </p>
						</div>
					</div>

					<div class="col-12 col-md-4 p-4">
						<div class="px-4 block shadow">
							<img class="mt-5" src="_img/main/especialidades/16.png" alt="Consultas">
							<p class="mt-2 mb-0"> Análise de Líquido </p>
						</div>
					</div>

					<div class="col-12 col-md-4 p-4">
						<div class="px-4 block shadow">
							<img class="mt-5" src="_img/main/especialidades/17.png" alt="Consultas">
							<p class="mt-2 mb-0"> Andrológico </p>
						</div>
					</div>
				</div>
			</div>
		...
		<section id="pet-shop" class="bg-light">
			<div class="container p-5">
				<div class="row mb-1">
					...
					<p class="m-0 col-12 text-secondary section-description d-none d-md-block"> Todos os produtos que
						seu pet precisa, desde uma imensa variedade de rações até uma farmácia veterinária. Disk Entrega
						via WhatsApp. </p>
					<p class="m-0 col-12 text-secondary section-description d-block d-md-none"> Todos os produtos que
						seu pet precisa, desde rações até uma farmácia veterinária. Disk Entrega via WhatsApp. </p>

					<div class="col-12 mt-3">
						<a class="btn btn-outline-info"
							href="https://wa.me/559292156295?text=Ol%C3%A1%2C%20Dr.%20Paulo%20Vet.%20%F0%9F%98%8A"
							target="_blank"> Disk Entrega </a>
					</div>
				</div>
		...
		<section id="mural-animal">
			<div class="container p-5">
				<div class="row mb-1">
					...
					<p class="section-description m-0 col-12 text-secondary"> Olha só essa galerinha. Sãos os pets do
						nosso Instagram fazendo uma visitinha ao nosso Mural Animal. Traga o seu pet também! </p>

					<div class="col-12 mt-3">
						<a class="btn btn-outline-info" href="https://www.instagram.com/dr.paulovet" target="_blank">
							Visitar Instagram </a>
					</div>
				</div>
	...
	<footer class="text-white">
		<div class="container pt-5 px-5">
			<div class="row">
				<article class="col-12 col-md-4 mb-5 mb-md-0">
					<h3> + Saiba Mais </h3>
					<p> Dr. Paulo Vet. é uma Clínica Veterinária e Pet Shop localizada em Manaus que realiza consulta
						veterinária e Disk Entrega. </p>
			...
			<div class="row pt-5 pb-3">
				...
				<div class="col-6 text-right">
					<a class="text-white" target="_blank" href="https://www.fabriciobatalha.dev"> Desenvolvido por
						Fabrício S. Batalha </a>
				</div>
			</div>
		</div>
	</footer>
